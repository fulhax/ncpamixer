...
ENDIF(CURSES_NEED_WIDE)
SET(CURSES_MENU_LIBRARY_NAME "menu")
IF(CURSES_NEED_WIDE)
	SET(CURSES_MENU_LIBRARY_NAME "menuw")
ENDIF(CURSES_NEED_WIDE)
...
FIND_LIBRARY(CURSES_MENU_LIBRARY "${CURSES_MENU_LIBRARY_NAME}" HINTS "${_cursesLibDir}")
FIND_LIBRARY(CURSES_MENU_LIBRARY "${CURSES_MENU_LIBRARY_NAME}" )

# for compatibility with older FindCurses.cmake this has to be in the cache
# FORCE must not be used since this would break builds which preload a cache
# with these variables set
SET(FORM_LIBRARY "${CURSES_FORM_LIBRARY}" CACHE FILEPATH "The curses form library")
SET(MENU_LIBRARY "${CURSES_MENU_LIBRARY}" CACHE FILEPATH "The curses form library")
...
IF(CURSES_MENU_LIBRARY)
	SET(CURSES_LIBRARIES ${CURSES_LIBRARIES} ${CURSES_MENU_LIBRARY})
ENDIF(CURSES_MENU_LIBRARY)
...
MARK_AS_ADVANCED(CURSES_INCLUDE_PATH
		 CURSES_LIBRARY
